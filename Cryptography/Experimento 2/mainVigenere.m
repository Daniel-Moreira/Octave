...
for texto=1:Ntextos
  for tamanho=1:Nsize
    ...
    cifra = vigenereE(plain,keys(keyRealInd,:));

      % encontra a verossimilhanca de toda chave
    probs = mlVigenereDigrama(freq,keys,cifra);
    %probs = mlVigenereMonograma(freq,keys,cifra);
...
print -dpng lab2-vige.png
save lab2-vige.dat  probMax probReal entropia acertos
